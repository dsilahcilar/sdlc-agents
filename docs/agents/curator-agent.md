...
| `<project-root>/agent-context/features/<feature-id>/progress-log.md` | Historical context (feature-specific) |
...
| `<project-root>/agent-context/harness/progress-log.md` | Curation log (cross-feature) |
